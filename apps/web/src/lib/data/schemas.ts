...
const innerEventCreateSchema = z.object({
...
export const eventCreateSchema = innerEventCreateSchema
...
export const eventUpdateSchema = innerEventCreateSchema.partial().and(
  z.object({
